...
namespace DBUtility
{
	...
	public class ExcelHelper
	{
		...
		public ExcelHelper(string templetFilePath,string outputFilePath)
		{
            ...
            outputFilePath = outputFilePath + "\\" + path + ".xls";
            workBook.SaveAs(outputFilePath, missing, missing, missing, missing, missing, Excel.XlSaveAsAccessMode.xlNoChange, missing, missing, missing, missing);
