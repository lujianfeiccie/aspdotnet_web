...
namespace DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        //public static string connectionString = ConfigurationManager.AppSettings["WebConnectionString"];     		
        public static string connectionString = ConfigurationManager.ConnectionStrings["WebConnectionString"].ConnectionString;
        public DbHelperSQL()
        {            
        }
        ...
        public static void debugoutput(DataTable text)
        {
        ...
        public static void debugoutputtext(string text)
        {
