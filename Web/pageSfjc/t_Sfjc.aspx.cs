...
public partial class t_Sfjc : System.Web.UI.Page
{
    ...
    private void BinData()
    {
        ...
        Repeater1.DataSource = bll_temp_sfjc.GetViewList(AspNetPager1.StartRecordIndex, AspNetPager1.EndRecordIndex, strWhere);
        Repeater1.DataBind();
        strWhere = "";
     }
    ...
    private void init()
    {
        ...
        AspNetPager1.RecordCount = bll_temp_sfjc.GetViewAllList().Tables[0].Rows.Count;
    ...
    protected void lbtnRecovery_Click(object sender, EventArgs e)
    {
        ...
        Model.tb_sfjc temp = bll_temp_sfjc.GetModel(id);
        bll_temp_sfjc.Delete(id);
