...
namespace DAL
{
	...
	public class TB_Province
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "TB_Province"); 
		}
		...
		public void Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete TB_Province ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
			parameters[0].Value = ID;
		...
		public Model.TB_Province GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Name from TB_Province ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
			parameters[0].Value = ID;

			Model.TB_Province model=new Model.TB_Province();
